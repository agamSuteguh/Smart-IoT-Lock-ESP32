...
- **Professional UI:** Tampilan OLED yang informatif dengan credit Github.
...
4. Chat @BotFather kirim /newbot lalu isi sesuai pertanyaaa hingga ada `Use this token to access the HTTP API:`
5. Masukkan `SSID Wifi`, `Password`, `Bot Token`, dan `Chat ID` di file `DONT UPDATE YET`.
